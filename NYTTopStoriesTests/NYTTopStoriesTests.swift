...
""".data(using: .utf8)! // takes the string and converts it into data
        
        // act
        
        // needed to access the properties...
        ...
        //ACT
        do {
            // { curly brace means a dicitonary .. need to go inside of the dictionary first.
